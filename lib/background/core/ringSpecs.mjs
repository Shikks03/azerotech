// Canonical ring geometry constants + helpers for the idle background. Pure
// data/logic — no THREE, no DOM — so it stays testable and browser-independent.
...
export const RING_DIMENSIONS = Object.freeze({
  ...
  halfDepth: 0.11,
  fillet: 0.055,
  tubularSegments: 120, // background scale hides the difference vs 168; fewer verts
});
